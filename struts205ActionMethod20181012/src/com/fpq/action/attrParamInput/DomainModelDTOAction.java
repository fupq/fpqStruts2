...
public class DomainModelDTOAction extends ActionSupport{
	...
	/**
	 * http://localhost:8080/struts205ActionMethod20181012/attrParamInput/DomainModelDTO_add.action?userDTO.name=carson&userDTO.age=5&userDTO.password=Carson@20131111&userDTO.confirmPassword=Carson@20131111
	 * @return
	 */
	public String add() {
		try {
	...
	/**
	 * http://localhost:8080/struts205ActionMethod20181012/attrParamInput/DomainModelDTO_delete.action?userDTO.name=carson&userDTO.age=5&password=Carson@20131111&confirmPassword=Carson@20131111
	 * @return
	 */
