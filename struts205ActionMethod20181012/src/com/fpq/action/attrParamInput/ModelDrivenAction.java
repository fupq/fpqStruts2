...
public class ModelDrivenAction extends ActionSupport  implements ModelDriven<User>{
	...
	/*
     * http://localhost:8080/struts205ActionMethod20181012/attrParamInput/ModelDriven_add.action?user.name=carson&user.age=5
     * @return
	 */
	public String add() {
	...
	/*
     * http://localhost:8080/struts205ActionMethod20181012/attrParamInput/ModelDriven_delete.action?user.name=carson&user.age=5
     * @return
	 */
