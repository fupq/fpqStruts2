...
public class DomainModelAction extends ActionSupport{
	...
	/*
     * http://localhost:8080/struts206DataCheck20181016/attrParamInput/DomainModel_add.action?user.name=carson&user.age=5
     * @return
	 */
	public String add() {
	...
	/*
     * http://localhost:8080/struts206DataCheck20181016/attrParamInput/DomainModel_delete.action?user.name=carson&user.age=5
     * @return
	 */
